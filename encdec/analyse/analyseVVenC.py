...
from metrics import getPSNR, getSSIM, getVMAF, get_encInfo, calPSNR, calSSIM
    ...
    for size in sizes:
        ...
        for seq in tqdm(seqs, desc=f"size {size}"):
            ...
            for rec_yuv in os.listdir(rec_dir):
                ...
                enc_info = get_encInfo(os.path.join(seq_dir, "log", rec_yuv.replace("yuv", "log")), read_psnr=False)
